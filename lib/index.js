...
module.exports = function nuxt7(moduleOptions) {
    const options = Object.assign({}, moduleOptions, this.options.framework7)
    ...
    this.extendBuild(config => {
        ...
        // framework7-css
        config.resolve.alias['framework7-css'] = resolveDep('@pi0/framework7/dist/css/framework7.css')
